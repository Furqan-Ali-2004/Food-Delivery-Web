      ...
      <div className="w-[60%] h-full flex gap-5">
        ...
        <div className="w-[60%] h-full flex flex-col gap-5">
          ...
          <div className="w-[110px] h-[33px] bg-zinc-800 rounded-full flex">
            <button
              className="w-[30%] h-full bg-zinc-900/80 rounded-full text-red-500 text-xl font-bold transition-shadow duration-100 active:shadow-[-6px_0_8px_-1px_rgba(239,68,68,0.6)]"
              onClick={() => {
            ...
            <button
              className="w-[30%] h-full bg-zinc-900/80 rounded-full text-green-500 text-lg font-bold transition-shadow duration-100 active:shadow-[6px_0_8px_-1px_rgba(34,197,94,0.6)]"
